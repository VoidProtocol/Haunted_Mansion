...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty fullMagnitude;
    ...
    protected virtual void OnEnable()
    {
        ...
        fullMagnitude = serializedObject.FindProperty("fullMagnitude");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(fullMagnitude, new GUIContent("Full Magnitude", "The distance away from the center input has to be before setting full magnitude"));
